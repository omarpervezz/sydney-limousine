...
//   return (
//     <section className="relative bg-cover bg-center pt-72 pb-36 banner">
...
//           </h1>
//           <p className="text-white text-base md:text-lg mb-4 leading-tight">
//             Experience Luxurious Chauffeur Driven Cars in Australia.
//           </p>
//           <p className="text-white text-base md:text-lg mb-8 leading-tight">
...
//             <button className="w-full md:w-48 h-12 bg-teal-700 text-white font-semibold rounded-md border-2 border-teal-700 hover:translate-y-[-3px] transition-transform">
//               <a href="test.php">INSTANT QUOTATION</a>
//             </button>
//             <button className="w-full md:w-48 h-12 bg-transparent text-white font-semibold rounded-md border-2 border-blanchedalmond hover:translate-y-[-3px] transition-transform">
//               <a href="#">BOOK NOW</a>
//             </button>
//             <button className="w-full md:w-48 h-12 bg-transparent text-white font-semibold rounded-md border-2 border-blanchedalmond hover:translate-y-[-3px] transition-transform">
